...
class NavWalker extends \Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
        ...
        $a_tag_class    = 'font-secondary text-xl sm:text-4xl lg:text-base text-white lg:text-primary no-underline font-bold hover:text-secondary focus:text-secondary ease-in duration-200 inline-block flex items-center';
