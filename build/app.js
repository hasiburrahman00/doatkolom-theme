...
function Component() {
  ...
  const [isChecked, setChecked] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(meta.is_featured_post || 'no');
  const {
    editPost
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_2__.registerPlugin)('doatkolom-editor-sidebar', {
  icon: 'palmtree',
  render: Component
});
})();
