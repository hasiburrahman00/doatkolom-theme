...
/***/ "./resources/typescript/events/wpAdminbarResize.ts":
/*!*********************************************************!*\
  !*** ./resources/typescript/events/wpAdminbarResize.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _inc_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/inc/constants */ "./resources/typescript/inc/constants.ts");
...
window.addEventListener('DOMContentLoaded', function () {
  var eventName = 'doatkolom/wp-adminbar';
  var value;
  var dispatchEvent = function dispatchEvent(detail) {
  ...
  if (element) {
    ...
    var resizeCallback = function resizeCallback() {
      ...
      if (!(0,lodash__WEBPACK_IMPORTED_MODULE_1__.isEqual)(value, newValue)) {
        value = newValue;
...
/***/ "./resources/typescript/inc/constants.ts":
/*!***********************************************!*\
  !*** ./resources/typescript/inc/constants.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/typescript/webComponents/header/index.ts":
/*!************************************************************!*\
  !*** ./resources/typescript/webComponents/header/index.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Header = /*#__PURE__*/function (_LitElement) {
  ...
  function Header() {
    ...
    _this.eventName = 'doatkolom/resize-header';
    _this.css = {
      height: 0,
      width: 0
    };
  ...
  _createClass(Header, [{
    ...
    value: function events() {
      var self = this;
      window.addEventListener('doatkolom/wp-adminbar', function (ev) {
    ...
    key: "eventdispatch",
    value: function eventdispatch() {
      window.dispatchEvent(new CustomEvent(this.eventName, {
        detail: this.css
      }));
    }
  }, {
    key: "innerElementObserver",
    value: function innerElementObserver() {
      var self = this;
      var element = self.querySelector('header');
      if (!element) return;
      var observer = new ResizeObserver(function () {
        var _element$getBoundingC = element.getBoundingClientRect(),
          height = _element$getBoundingC.height,
          width = _element$getBoundingC.width;
        if (!(0,lodash__WEBPACK_IMPORTED_MODULE_2__.isEqual)(self.css, {
          width: width,
          height: height
        })) {
          self.css = {
    ...
    key: "calcHeaderPosition",
    value: function calcHeaderPosition() {
      var value = this.wpAdminbar.height;
      if (this.wpAdminbar.offsetTop <= 0) {
        value = this.wpAdminbar.height - Math.abs(this.wpAdminbar.offsetTop);
      } else {
...
/******/ 	__webpack_require__.O(undefined, ["assets/css/app","assets/css/fonts"], () => (__webpack_require__("./resources/typescript/app.ts")))
/******/ 	__webpack_require__.O(undefined, ["assets/css/app","assets/css/fonts"], () => (__webpack_require__("./resources/scss/fonts.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css/app","assets/css/fonts"], () => (__webpack_require__("./resources/scss/app.scss")))
