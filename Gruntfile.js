...
module.exports = (grunt) => {
    ...
    const projectConfig = {
        name: 'doatkolom', // should be the text domain of the project
        srcDir: './', // the source directory of the plugin
        distDir: `../dist/doatkolom/`,
        version: '0.0.1', // where to save the built file
    };
                ...
                files: [
                    {
                        ...
                        src: [
                            ...
                            '!' + projectConfig.srcDir + 'readme.md',
                            '!' + projectConfig.srcDir + '*.config.js',
	...
	# Version   : ${projectConfig.version}`.cyan,
            textdomainchecking: `Checking textdomain [${projectConfig.name}]`
                .cyan,
            textdomainfixing: `Fixing textdomain [${projectConfig.name}]`.cyan,
