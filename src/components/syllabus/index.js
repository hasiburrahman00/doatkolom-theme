    ...
    return (
        <div className="bg-gray-100 border border-gray-500 border-solid py-7 px-5 hover:bg-primary-blue-100 hover:border-secondary transition duration-100 ease-linear">
            <div className="flex items-center mb-3">
                ...
                <div className="ml-5">
                    <span className="text-primary font-secondary font-normal text-base">Uploaded on</span>
                    <h5 className="text-primary font-secondary font-normal text-lg">3th June 2022</h5>
                </div>
            </div>
            {props.topic && <h2 className="text-primary font-secondary font-bold text-xl">{props.topic}</h2>}
            <p className="text-primary font-secondary font-normal text-base mt-3">The school was established on a small scale on 19th</p>
