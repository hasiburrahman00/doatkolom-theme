            ...
            <div className="grid md:grid-cols-3">
                { attributes.event_list.map((item,index)=>(
                    <div className="border border-solid border-gray-200 py-6 px-3.5" key={index}>
                        ...
                        <a href={item.reademore_link} className="flex items-center font-secondary text-lg font-normal text-primary no-underline">
                            <span className="w-12 h-12 rounded-full bg-gray-100 inline-flex justify-center items-center mr-4">
                                <RightArrow/>
                            </span> Read More
                        </a>
                    </div>               
