                    ...
                    <div class="md:flex md:flex-wrap sm:w-full lg:w-full">
                        { attributes.event_list.map((item,index)=>(
                            <div class=" border border-solid border-gray-200 md:w-2/6 sm:w-full py-6 px-3.5">
                                ...
                                <a href={item.reademore_link} className="flex items-center font-secondary text-lg font-normal text-primary no-underline"><span className="inline-block w-12 h-12 rounded-full bg-gray-100 flex justify-center items-center mr-4"><RightArrow/></span> Read More</a>
                            </div>               
                        ))}
                    </div>
                </div>
