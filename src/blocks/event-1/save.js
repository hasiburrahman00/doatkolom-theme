                ...
                { attributes.event_list.map((item,index)=>(
                    <div className="border border-solid border-gray-200 py-6 px-3.5" key={index}>
                        <div className="font-secondary text-6xl text-primary font-weight_primary">
                            ...
                            <span className="text-lg font-weight_secondary m-0 -mt-2 block capitalize pl-1.5">{item.event_month}</span>
                        </div>
                        ...
                        <p className="font-secondary text-lg text-primary font-weight_secondary m-0 mb-9">{item.event_details}</p>
                        <a href={item.reademore_link} className="group inline-flex items-center font-secondary text-lg font-weight_secondary text-primary no-underline hover:text-primary hover:underline">
