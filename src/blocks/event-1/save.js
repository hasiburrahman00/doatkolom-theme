            ...
            <div className="grid md:grid-cols-3">
                { attributes.event_list.map((item,index)=>(
                    <div className="border border-solid border-gray-200 py-6 px-3.5" key={index}>
                        ...
                        <a href={item.reademore_link} className="group inline-flex items-center font-secondary text-lg font-normal text-primary no-underline hover:text-primary hover:underline">
