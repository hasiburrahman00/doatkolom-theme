	...
	return (
		<div className="banner-wrapper bg-cover bg-no-repeat">
            <div className="max-w-screen-xl px-2 sm:px-5 lg:px-56 py-14 mx-auto md:py-20 text-center">
                <h2 className="m-0 text-white font-primary font-weight_secondary text-3xl leading-[40px] md:text-5xl md:leading-[80px]">{attributes.title}</h2>
                <p className="text-white m-0 mt-5 font-secondary font-weight_secondary text-base md:text-lg">{attributes.description}</p>
                {
