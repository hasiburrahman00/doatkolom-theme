            ...
            <div className="max-w-screen-xl grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mx-auto px-5 mt-10">
                {
                    attributes.features?.map((item, index) => (
                        <a href="#" className="no-underline group bg-white rounded-md flex justify-center items-center flex-col space-y-5 p-10 hover:shadow-lg transition-all duration-200 ease-linear" key={index}>
                            <picture>
                                <img src={item.image}/>
                            </picture>
