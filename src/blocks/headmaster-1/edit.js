        ...
        <div className="max-w-screen-xl mx-auto px-5 py-10 md:py-20">
            <div className="lg:flex items-center">
                ...
                <div className="pt-20 lg:pt-0 lg:pl-20">
                    ...
                    <a href="#" className="inline-block sm:inline-flex group items-center font-secondary text-lg font-weight_secondary text-primary no-underline mt-5 md:mt-10 sm:space-x-5">
