            ...
            <div className="py-24 md:py-52 px-5">
                <div className="max-w-screen-xl mx-auto">
                    <div className="max-w-[620px]">
                        ...
                        <a className="no-underline font-weight_tertiary text-white py-3 px-8 bg-primary hover:bg-primary_dark font-secondary inline-block mt-7 rounded-md hover:text-white text-base" href="#">{attributes.banner_btn.text}</a>
                    </div>
                </div>
            </div>
        </div>
