            ...
            <div className="bg-white-90 py-16 md:py-24">
                <div className="max-w-screen-xl lg:px-0 px-5 mx-auto">
                    <div className="header text-center">
                            <h2 className="font-primary m-0 mb-3 font-weight_primary text-primary text-3xl md:text-5xl leading-9">{attributes.heading}</h2>
                            <p className="sub-header font-secondary font-weight_primary text-primary leading-6 text-lg lg:text-lg mb-7 ">{attributes.sub_heading}</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-8">
                            {
                                attributes.priority_box.map((item,index)=>(
                                    <div key={index} className="main-prioritybox mb-3 bg-white p-5 shadow-lg last: ml-0">
                                        ...
                                        <p className="font-secondary m-0 mt-5 font-weight_primary text-primary text-lg leading-7">{item.description}</p>

                                    <div className="mt-7">
                                        {
                                            item.button.visible &&
                                            <a href={item.button.url} className="inline-flex items-center text-primary group">
