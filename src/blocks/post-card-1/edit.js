    ...
    wp.element.useEffect(()=>{
        if( !attributes.post_card ) {
            setAttributes({post_card:[
                ...
                {
                  image: doatkolom_object.blocks + 'post-card-1/img/teacher3.webp',
                  names: "Samia Rahman",
                  position: "Urdu Studies and Literature",
                  description: "The school was established on April 19, 1959 on a small scale by the initiative of some personalities. The school was established on 19 April 1959 on a small scale by the initiative of some personalities",
                  post_btn: {
                ...
                {
                  image: doatkolom_object.blocks + 'post-card-1/img/teacher4.webp',
                  names: "Mohammad Rafiquzzaman",
                  position: "Public Administration, University of Dhaka",
                  description: "The school was established on April 19, 1959 on a small scale by the initiative of some personalities. The school was established on 19 April 1959 on a small scale by the initiative of some personalities",
                  post_btn: {
                ...
                {
                  image: doatkolom_object.blocks + 'post-card-1/img/teacher5.webp',
                  names: "Mohammad Rafiquzzaman",
                  position: "Public Administration, University of Dhaka",
                  description: "The school was established on April 19, 1959 on a small scale by the initiative of some personalities. The school was established on 19 April 1959 on a small scale by the initiative of some personalities",
                  post_btn: {
                ...
                {
                  image: doatkolom_object.blocks + 'post-card-1/img/teacher6.webp',
                  names: "Samia Rahman",
                  position: "Urdu Studies and Literature",
                  description: "The school was established on April 19, 1959 on a small scale by the initiative of some personalities. The school was established on 19 April 1959 on a small scale by the initiative of some personalities",
                  post_btn: {
                ...
                {
                  image: doatkolom_object.blocks + 'post-card-1/img/teacher7.webp',
                  names: "Samia Rahman",
                  position: "Urdu Studies and Literature",
                  description: "The school was established on April 19, 1959 on a small scale by the initiative of some personalities. The school was established on 19 April 1959 on a small scale by the initiative of some personalities",
                  post_btn: {
                ...
                {
                  image: doatkolom_object.blocks + 'post-card-1/img/teacher8.webp',
                  names: "Mohammad Rafiquzzaman",
                  position: "Public Administration, University of Dhaka",
                  description: "The school was established on April 19, 1959 on a small scale by the initiative of some personalities. The school was established on 19 April 1959 on a small scale by the initiative of some personalities",
                  post_btn: {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {
                    attributes.post_card?.map((item,index)=>(
                        <div key={index} className="mb-4">
                            <div className="h-[350px] overflow-hidden">
                                {
                                    ...
                                    <a href="#">
                                        <picture>
                                            <img width="500" height="350" className="w-full h-full object-cover" src={item.image} alt="teacher-image"/>
                                        </picture>
                                    </a>
                                    :
                                    <picture>
                            ...
                            {
                                item.post_btn.visible && 
                                <a className="inline-block mt-6 font-secondary font-weight_secondary text-base no-underline bg-primary py-2 px-5 rounded-md text-white hover:text-white hover:bg-primary_dark transition ease-linear duration-150" href="#">{item.post_btn.text}</a>
                            }
                        </div>
                    ))
                }
