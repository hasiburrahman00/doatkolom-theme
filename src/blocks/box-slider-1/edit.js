	...
	return (
          ...
          <div className="main-box-slider relative">
            <div className="box-slider">
              ...
              <button className="slick-prev-btn w-[50px] h-[50px] rounded-full border-none bg-red-100 hover:bg-red-500 transition ease-linear duration-150 cursor-pointer absolute top-[25%] right-[-65px] translate-y-[-50%] z-10 hidden lg:block">
                  <PrevArrow/>
              </button>
              <button className="slick-next-btn w-[50px] h-[50px] rounded-full border-none bg-red-100 hover:bg-red-500 transition ease-linear duration-150 cursor-pointer absolute top-[25%] left-[-65px] translate-y-[-50%] z-10 hidden lg:block">
                  <NextArrow/>
              </button>
          </div>
      </div>
