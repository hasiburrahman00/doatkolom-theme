                            ...
                            <div key={index}>
                                ...
                                <div className="flex items-center mb-5 lg:mb-0">
                                    <picture className="block lg:hidden overflow-hidden">
                                        <img width="100" height="120" className="object-contain w-28 h-28 lazyload" data-src={item.image} alt="teacher-image" />
                                    </picture>
                        ...
                        <div className="testimonials-slides lg:mx-auto">
                            {
                                attributes.teachers?.map((item,index)=>(
                                    <div className="text-center w-[370px] h-[350px] overflow-hidden" key={index}>
                                        <picture>
                                            <img width="370" height="350" className="object-contain lazyload  h-full" data-src={item.image} alt="teachers" />
                                        </picture>
                                    </div>
                                ))
                            }         
