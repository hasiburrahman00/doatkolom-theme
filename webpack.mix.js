...
mix.blocks('src/blocks.js', 'build/doatkolom-blocks.min.js')

mix.options({ processCssUrls: false });
mix.sass('src/simple.scss', 'build/doatkolom-simple.min.css')
mix.sass('src/home.scss', 'build/doatkolom-home.min.css')
mix.sass('src/app.scss', 'build/doatkolom-product.min.css')
mix.sass('src/blog.scss', 'build/doatkolom-blog.min.css')



mix
.js("src/simple.js", "build/doatkolom-simple.min.js")
.js("src/app.js", "build/doatkolom-product.min.js")
.js("src/home.js", "build/doatkolom-home.min.js")
.js("src/blog.js", "build/doatkolom-blog.min.js")
.webpackConfig({
    externals: {
        "jquery": "jQuery"
    },
