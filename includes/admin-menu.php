...
function doatkolom_theme_dashboard_menu()
{
    ...
    add_submenu_page( 'doatkolom-theme-settings', 'Dashboard', 'Dashboard', 'manage_options', 'admin.php?page=doatkolom-theme-settings' );
    add_submenu_page( 'doatkolom-theme-settings', 'Contact', 'Contact', 'manage_options', 'edit.php?post_type=doatkolom-contact' );
}
